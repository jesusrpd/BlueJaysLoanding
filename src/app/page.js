...
export default function Home() {
  return (
    <>
      <main className='w-full h-screen bg-main bg-cover flex items-center relative bg-grayjays'>
      ...
      <section className='w-full min-h-screen bg-paper bg-cover pt-28 flex flex-col items-center px-4 pb-20'>
        ...
        <Image src="/img/food/sope.png" alt='sope saucer' width={223} height={103} className='absolute negative-sope'/>
      </section>
      <section className='w-full min-h-screen bg-horary bg-contain pt-28 flex flex-col items-center px-4 pb-20 relative justify-center bg-grayjays'>
        ...
        <Image src="/img/food/pulpe.png"  alt='food pulpe' width={196} height={189} className='absolute right-0 negative-pulpe'/>
      </section>
      <section className='w-full min-h-screen bg-paper bg-cover pt-28 flex flex-col items-center pb-24 px-10'>
      ...
      <footer className='w-full min-h-screen bg-footer bg-cover relative bg-grayjays'>
        <Image src="/img/logotipo.png" alt='logotipo BlueJays' width={150} height={105}/>
      </footer>
    </>
  )
}
